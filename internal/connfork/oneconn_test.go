...
// TestOneConnListener_CloseUnblocks verifies that closing the listener
// directly unblocks a waiting Accept.
func TestOneConnListener_CloseUnblocks(t *testing.T) {
	...
	// Consume the single connection without closing it.
