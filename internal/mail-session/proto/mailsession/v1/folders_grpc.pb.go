...
const (
	FolderService_ListFolders_FullMethodName  = "/mailsession.v1.FolderService/ListFolders"
	FolderService_CreateFolder_FullMethodName = "/mailsession.v1.FolderService/CreateFolder"
	FolderService_DeleteFolder_FullMethodName = "/mailsession.v1.FolderService/DeleteFolder"
	FolderService_RenameFolder_FullMethodName = "/mailsession.v1.FolderService/RenameFolder"
)
...
//
// FolderService handles folder management within a user's mailbox.
// Mirrors scmp's FolderService for protocol alignment.
type FolderServiceClient interface {
	// ListFolders returns all folders for the current mailbox.
...
var FolderService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "mailsession.v1.FolderService",
	...
	Metadata: "mailsession/v1/folders.proto",
}
