...
// for the lifetime of its single POP3 session; at exit the caller hands the
...
// ParentMetrics is the pop3d dispatcher's metrics surface: parent-owned
...
// NewParentMetrics builds the dispatcher metrics surface in the pop3d
// namespace and registers it on reg.
func NewParentMetrics(reg prometheus.Registerer) *ParentMetrics {
	return procmetrics.NewParentMetrics(reg, "pop3d")
}
